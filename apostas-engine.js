        ...
        if (loader) {
            loader.innerHTML = `
                <div class="text-center p-6">
                    ...
                    <button onclick="window.location.reload(true)" class="mt-4 bg-red-600 text-white px-4 py-2 rounded-lg text-sm">Tentar novamente</button>
                </div>
            `;
        }
    }
